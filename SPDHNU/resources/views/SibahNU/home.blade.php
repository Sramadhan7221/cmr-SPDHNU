            ...
            <div class="card-body">
              ...
              <ul
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    id="pills-data-mwcnu-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-data-mwcnu"
                    type="button"
                    role="tab"
                    aria-controls="pills-data-mwcnu"
                    aria-selected="true">
                ...
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link"
                    id="pills-data-pimpinan-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-data-pimpinan"
                    type="button"
                    role="tab"
                    aria-controls="pills-data-pimpinan"
                    aria-selected="false">
                    <i class="ri-file-copy-2-line"></i>
                    Data Pimpinan MWCNU
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link"
                    id="pills-data-operator-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-data-operator"
                    type="button"
                    role="tab"
                    aria-controls="pills-data-operator"
                    aria-selected="false">
                    <i class="ri-file-copy-2-line"></i>
                    Data Operator MWCNU
                  </button>
                ...
                <li class="nav-item" role="presentation">
                  <button
                    class="nav-link"
                    id="pills-data-persyaratan-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#pills-data-persyaratan"
                    type="button"
                    role="tab"
                    aria-controls="pills-data-persyaratan"
                    aria-selected="false">
                    <i class="ri-file-copy-2-line"></i>
              ...
              <div class="tab-content pt-2" id="myTabContent">
                <div
                  ...
                  id="pills-data-mwcnu"
                  role="tabpanel"
                  aria-labelledby="data-mwcnu-tab">
                ...
                <div
                  class="tab-pane fade"
                  id="pills-data-pimpinan"
                  role="tabpanel"
                  aria-labelledby="data-pimpinan-tab">
                  <!-- Multi Columns Form -->
                  <form>
                ...
                <div
                  class="tab-pane fade"
                  id="pills-data-operator"
                  role="tabpanel"
                  aria-labelledby="data-operator-tab">
                  <!-- Multi Columns Form -->
                  <form>
                    <div class="row g-3 mt-4">
                      <div class="col-md-4">
                ...
                <div
                  class="tab-pane fade"
                  id="pills-data-persyaratan"
                  role="tabpanel"
                  aria-labelledby="data-persyaratan-tab">
