        ...
        <div class="col-lg-7">
          <div class="row">
            ...
            <div class="col-lg-6">
              <p>: 123</p>
              <p>: 1(Satu) Berkas </p>
              <p>: Permohonan Pencairan<br>Bantuan Hibah Nahdlatul Ulama Tahun<br>Anggaran 2023</p>
            </div>
          </div>
        </div>
        <div class="col-lg-5">
          <p>Tasikmalaya, 18 Juli 2023<br>    Kepada<br>Yth. Ketua PCNU Kab.Tasikmalaya</p>
          <p>di Tasikmalaya</p>
        </div>
      </div>
    </div>
